            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        ...
                        color = if (executionResult is ExecuteAppFunctionResult.Error) MaterialTheme.colorScheme.error else MaterialTheme.colorScheme.onSurface,
                    )
                    ...
                    Row(
                        ...
                        Surface(
                            ...
                            border = if (isOkFocused) BorderStroke(2.5.dp, MaterialTheme.colorScheme.onPrimaryContainer) else null,
                        ) {
                            Text(
                                text = "OK",
                                style = MaterialTheme.typography.titleMedium,
                                fontWeight = FontWeight.Bold,
                                color = if (isOkFocused) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onPrimaryContainer,
                        ...
                        gridItemsIndexed(
                            ...
                            Surface(
                                ...
                                modifier = Modifier
                                    ...
                                    .scale(scale)
                                    .then(
                                        if (isTargetApp) Modifier.focusRequester(targetAppFocusRequester)
                                        else if (isFirstAppOverall) Modifier.focusRequester(firstAppFocusRequester)
                                        else Modifier,
                                    )
                                    .then(
                                        if (shouldFocus) {
                                            Modifier.onGloballyPositioned {
                                                if (!focusRequested) {
                                                    if (isTargetApp) targetAppFocusRequester.requestFocus()
                                                    else firstAppFocusRequester.requestFocus()
                                                    focusRequested = true
                                                }
                                            }
                                        } else Modifier
                                ...
                                shape = MaterialTheme.shapes.medium,
                                color = if (isCardFocused) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.surfaceContainerLow,
                                ...
                                Row(
                                    ...
                                    Column(modifier = Modifier.weight(1f)) {
                                        Text(
                                            ...
                                            color = if (isCardFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurface,
                                        )
                                        Text(
                                            ...
                                            maxLines = 1,
                                            overflow = TextOverflow.Ellipsis,
                                            color = if (isCardFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                                        )
                                    }
                                }
                            }
...
private fun TvFunctionListScreen(
    ...
    val isPinned = remember(uiState.filteredApps, selectedApp.packageName) {
        uiState.filteredApps.sections.firstOrNull { it.titleRes == R.string.debugging_pinned_apps }?.apps?.any { it.packageName == selectedApp.packageName } == true
    }
                        ...
                        Column {
                            ...
                            columnItemsIndexed(items = functions, key = { _, fn -> fn.id }) { index, function ->
                                ...
                                Surface(
                                    ...
                                    modifier = Modifier
                                        ...
                                        .then(
                                            if (shouldFocus) {
                                                Modifier.onGloballyPositioned {
                                                    if (!focusRequested) {
                                                        if (isTargetFunction) targetItemFocusRequester.requestFocus()
                                                        else firstItemFocusRequester.requestFocus()
                                                        focusRequested = true
                                                    }
                                                }
                                            } else Modifier
                                    ...
                                    shape = MaterialTheme.shapes.medium,
                                    color = if (isFunctionFocused) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.surfaceContainerLow,
                                    border = if (isFunctionFocused) {
                                        BorderStroke(2.5.dp, MaterialTheme.colorScheme.primary)
                                    } else null,
                                ) {
                                    Row(
                                        ...
                                        Surface(
                                            shape = CircleShape,
                                            color = if (isFunctionFocused) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.surfaceVariant,
                                            modifier = Modifier.size(36.dp),
                                        ) {
                                            Box(contentAlignment = Alignment.Center) {
                                                Icon(
                                                    ...
                                                    contentDescription = null,
                                                    tint = if (isFunctionFocused) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurfaceVariant,
                                        ...
                                        Column(modifier = Modifier.weight(1f)) {
                                            Text(
                                                ...
                                                style = MaterialTheme.typography.titleMedium,
                                                fontWeight = FontWeight.Bold,
                                                color = if (isFunctionFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurface,
                                            )
                                            Text(
                                                text = function.id,
                                                style = MaterialTheme.typography.labelSmall,
                                                ...
                                                maxLines = 1,
                                                overflow = TextOverflow.Ellipsis,
                                                color = if (isFunctionFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                                            )
                                        }
                                        Spacer(modifier = Modifier.width(16.dp))
                                        Surface(
        ...
        if (function.parameters.isEmpty()) {
            ...
            LazyColumn(
                ...
                columnItemsIndexed(
                    ...
                    val currentValue = inputValues[parameter.name]
                    ...
                    fun ResetButton() {
                        ...
                        Surface(
                            onClick = {
                                val defaultValue = com.example.appfunctions.agent.ui.screens.debugging.createDefaultValue(parameter.dataType)
                            ...
                            shape = MaterialTheme.shapes.medium,
                            color = if (isResetFocused) MaterialTheme.colorScheme.errorContainer else MaterialTheme.colorScheme.surfaceContainerHigh,
                            border = if (isResetFocused) BorderStroke(2.dp, MaterialTheme.colorScheme.error) else null,
                        ) {
                            Row(
                                ...
                                Icon(
                                    ...
                                    tint = if (isResetFocused) MaterialTheme.colorScheme.onErrorContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                                    modifier = Modifier.size(18.dp),
                                )
                                ...
                                Text(
                                    ...
                                    fontWeight = FontWeight.Bold,
                                    color = if (isResetFocused) MaterialTheme.colorScheme.onErrorContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                                )
                            }
                        }
                    }
