                    ...
                    Surface(
                        ...
                        Row(
                            ...
                            Icon(
                                ...
                                tint = if (isAddFocused) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurfaceVariant,
                            ...
                            Text(
                                ...
                                color = if (isAddFocused) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                        }
                    }
                } else {
...
fun ComplexTypeInput(
    ...
    val cardScale by androidx.compose.animation.core.animateFloatAsState(if (isTv && isFocused) 1.02f else 1.0f, label = "complexInputScale")
        ...
        ListItem(
            overlineContent = {
                Row {
                    Text(
                        label,
                        color = if (isTv && isFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                    if (isRequired) {
                        Text(
                            text = stringResource(R.string.debugging_required_indicator),
            ...
            trailingContent = {
                Icon(
                    ...
                    contentDescription = null,
                    tint = if (isTv && isFocused) MaterialTheme.colorScheme.onPrimaryContainer else MaterialTheme.colorScheme.onSurfaceVariant,
                )
            },
            colors = ListItemDefaults.colors(containerColor = Color.Transparent),
        )
